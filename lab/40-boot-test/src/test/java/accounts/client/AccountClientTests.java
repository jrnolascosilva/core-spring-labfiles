...
public class AccountClientTests {
	...
	public void addAndDeleteBeneficiary() {
		...
		ResponseEntity<Beneficiary> newBeneficiaryResponse = restTemplate.getForEntity(newBeneficiaryLocation, Beneficiary.class);
		assertThat(newBeneficiaryResponse.getBody().getName()).isEqualTo("David");
