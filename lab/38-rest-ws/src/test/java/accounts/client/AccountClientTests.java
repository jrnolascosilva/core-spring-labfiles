...
public class AccountClientTests {
	...
	public void getAccount() {
		...
		// - Run the test and ensure that it passes.
		Account account = restTemplate.getForEntity(BASE_URL + "/accounts/{id}", Account.class, 0).getBody(); // Modify this line to use the restTemplate
	...
	public void createAccount() {
		...
		Account retrievedAccount = restTemplate.getForEntity(newAccountLocation, Account.class).getBody(); // Modify this line to use the restTemplate
	...
	public void addAndDeleteBeneficiary() {
		...
		URI location = restTemplate.postForLocation(BASE_URL + "/accounts/{accountId}/beneficiaries","David",1);   // Modify this line to use the restTemplate
